...
#' @export
add_attachment <- function(model_name, attachment_file){
...
#' @export
get_attachment <- function(model_name, attachment_name, attachment_path=''){
...
#' @param attachment_name The name of the attachment
#' @export
remove_attachment <- function(model_name, attachment_name){
...
#' @param model_name The name of the model.
#' @export
list_attachments <- function(model_name){
  result <- service.get('model-manage', paste('/1/model/', model_name, '/attachment', sep=''))
  code <- result[[1]]
  if(code == 200){
