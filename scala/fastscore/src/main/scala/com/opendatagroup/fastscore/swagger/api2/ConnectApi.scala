...
class ConnectApi(val defBasePath: String = "https://localhost/api/1/service",
  ...
  def activeSensorInstall(instance: String, desc: SensorDescriptor): Option[InlineResponse200] = {
    ...
    if (instance == null) throw new Exception("Missing required parameter 'instance' when calling ConnectApi->activeSensorInstall")

    if (desc == null) throw new Exception("Missing required parameter 'desc' when calling ConnectApi->activeSensorInstall")
  ...
  def activeSensorPoints(instance: String): Option[List[String]] = {
    ...
    if (instance == null) throw new Exception("Missing required parameter 'instance' when calling ConnectApi->activeSensorPoints")
  ...
  def activeSensorUninstall(instance: String, tapId: Integer) = {
    ...
    if (instance == null) throw new Exception("Missing required parameter 'instance' when calling ConnectApi->activeSensorUninstall")
   ...
   * @return List[Any]
   */
  def pneumoGet(instance: String): Option[List[Any]] = {
    // create path and map variables
    val path = "/{instance}/2/pneumo".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "instance" + "\\}",apiInvoker.escape(instance))
    ...
    if (instance == null) throw new Exception("Missing required parameter 'instance' when calling ConnectApi->pneumoGet")
